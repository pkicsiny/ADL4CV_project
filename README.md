...
The gif below shows the veolution of some example predictions during training by using two frames as input to predict the following frame. The GAN used here has two discriminators (spatial+temporal) with Wasserstein loss and gradient penalty.
